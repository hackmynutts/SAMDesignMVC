...
CREATE TABLE SAMDESIGN.EVENT_LOG_TB (
    Log_ID INT IDENTITY(1,1) NOT NULL CONSTRAINT PK_LOG_ID PRIMARY KEY,
    Table_Name NVARCHAR(100) 
        CONSTRAINT NN_EVENT_LOG_TABLE_NAME NOT NULL,
    Type_Event NVARCHAR(30) 
        CONSTRAINT NN_EVENT_LOG_TYPE_EVENT NOT NULL,
    Event_Desc   NVARCHAR(255) NULL,
    Stack_Trace  NVARCHAR(MAX) NULL,
    Done_On      DATETIME2 NULL,
    Done_By      NVARCHAR(50) NULL,
    Pre_Data     NVARCHAR(MAX) NULL,
    Post_Data    NVARCHAR(MAX) NULL
);
GO
